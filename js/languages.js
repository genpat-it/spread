...
gtiz_languages.it = {
  ...
  "cannot_remove_column_message" : "Non posso rimuovere la colonna indicata, perderesti il collegamento dei metadati con il tree.",
  ...
  "helps": {
    ...
    "macros": {
      "help": '<p>Questa sezione offre una raccolta in continua espansione di sequenze di azioni (macro), che possono essere ricercate e categorizzate per tag.</p><p>Il componente consente di cercare le macro e, utilizzando chiavi specifiche (<strong>title:</strong>, <strong>tag:</strong>, <strong>desc:</strong>), è possibile restringere la ricerca per concentrarsi su elementi specifici.</p><p>Attraverso l\'utilizzo della combinazione <strong>Ctrl+z</strong> puoi annullare l\'applicazione della macro mentre con <strong>Ctrl+y</strong> ripristinarla.</p>'
    },
  ...
  "remove_column": "Rimuoivi colonna",
  "rendering": "Rendering",
  "reset_default": "Reset default",
